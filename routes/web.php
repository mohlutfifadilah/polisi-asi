...
Route::post('/actionRegister', $controller_path . '\authentications\RegisterCover@actionRegister')->name(
  'actionRegister'
);
...
Route::post('/actionLupaPassword', $controller_path . '\authentications\ForgotPasswordCover@actionLupaPassword')->name(
  'actionLupaPassword'
);
