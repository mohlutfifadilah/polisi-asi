                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="name" placeholder="Isi Role" name="name"
                                aria-label="Isi Role" value="{{ $role->name }}"/>
                            <label for="name">Nama Role</label>
                        </div>
                        <button type="submit" class="btn btn-warning me-sm-3 me-1 data-submit">Edit</button>
                        <a href="{{ route('role.index') }}" class="btn btn-label-secondary">Batal</a>
